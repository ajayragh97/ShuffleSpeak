...
**For Windows:**
1. Download `ShuffleSpeak.exe` from the [Releases](https://github.com/yourusername/yourrepo/releases) page.
...
**For Ubuntu / Linux:**
1. Download the `shufflespeak_ubuntu` binary from the [Releases](https://github.com/yourusername/yourrepo/releases) page.
